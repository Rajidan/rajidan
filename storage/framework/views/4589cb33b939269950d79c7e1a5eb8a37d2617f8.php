      ...
      <tbody>
        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr>
            ...
            <td>
            <a href="<?php echo e(route('categories.restore', [$category->id])); ?>" class="btn btn-success">Restore</a>
            <form
  class="d-inline"
  action="<?php echo e(route('categories.delete-permanent', [$category->id])); ?>"
  method="POST"
...
<?php echo $__env->make('layouts.global', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\larashop_Rajidan\resources\views/categories/trash.blade.php ENDPATH**/ ?>